...
@section('content')
            <section class="content-header">
                <h1>
                    CC Checker via Stripe API with Socks5/Proxy
                </h1>
            </section>
            <section class="content">
            	<div class="col-md-8">
            		...
            		<form method="post" action="{{ url('/checker/stripe/proxified') }}">
            			{{ csrf_field() }}
            			...
            			<div class="form-group">
            				...
            				<input type="text" name="proxy" required autocomplete="on" class="form-control" placeholder="Enter SOCKS5/proxy here. e.g : 127.0.0.1:8080" value="{{ session('oldproxy') }}">
            			</div>
            			<div class="form-group">
                        ...
                        <div class="box box-danger">
                              ...
                              <div class="box-body">
                                    <table class="table table-striped">
                                          <tbody>
                                                <?php $lasterror = ""; ?>
                                                @foreach(session('results')[1] as $error)
                        ...
                        <div class="box box-primary">
                              ...
                              <div class="box-body">
                                    <table class="table table-bordered table-hover">
                                          ...
                                          <tbody>
                                                @foreach(session('results')[1] as $result)
